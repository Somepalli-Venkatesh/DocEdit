...
const Navbar = ({ setSearchQuery }) => { // Accept setSearchQuery as a prop
  ...
  const handleSearchChange = (e) => {
    ...
    setSearchQuery(value); // Call setSearchQuery to lift the state
  };
      ...
      <div className="right flex items-center justify-end gap-2">
        <div className="inputBox w-[30vw]">
          ...
          <input 
            ...
            value={searchTerm} // Set value for the input
